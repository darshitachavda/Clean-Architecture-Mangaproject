...
namespace Manga.Infrastructure.Migrations
{
    ...
    [Migration("20190729054723_InitialCreate1")]
            ...
            modelBuilder.Entity("Manga.Domain.Accounts.Credit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 400.0,
                            TransactionDate = new DateTime(2019, 7, 29, 5, 47, 22, 498, DateTimeKind.Utc).AddTicks(8351)
                        });
                });
            ...
            modelBuilder.Entity("Manga.Domain.Accounts.Debit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccountId = new Guid("4c510cfe-5d61-4a46-a3d9-c4313426655f"),
                            Amount = 400.0,
                            TransactionDate = new DateTime(2019, 7, 29, 5, 47, 22, 499, DateTimeKind.Utc).AddTicks(1634)
                        });
                });
